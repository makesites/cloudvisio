...
},{"d3":18}],2:[function(require,module,exports){
// dependencies
var d3 = require('d3'),
	arc = d3.svg.arc();
...
},{"d3":18}],4:[function(require,module,exports){
var d3 = require('d3');
...
var force = require('../charts/force'),
	pie = require('../charts/pie'),
	stack = require('../charts/stack');
...
var chart = {
	...
	_lookupSchema: function( type, preferred ){
		// fallbacks
		type = type || false;
...
},{"../charts/force":1,"../charts/pie":2,"../charts/stack":3}],8:[function(require,module,exports){
...
},{"d3":18}],11:[function(require,module,exports){
...
},{"../config/default":4,"./axis":6,"./chart":7,"./color":8,"./data":9,"./language":10,"./math":12,"./options.js":13,"./queries":14,"./regex":15,"./render":16,"./utils":17}],12:[function(require,module,exports){
(function(){
var math = {
...
var regex = {
	...
	_filterString: function( string, options ){
		//
		options = options || {};
		var field = this._selectedField || options.field || false;
		// exit now if theres no selected field
